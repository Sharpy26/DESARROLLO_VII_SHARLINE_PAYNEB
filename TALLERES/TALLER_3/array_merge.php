...
$misComidas = ["Arroz frito", "Sushi", "Lo que sea"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["Iryel", "Nicolle", "Hector"]; // Reemplaza con las comidas favoritas de tu amigo
