...
$miArray = ["Sharline Payne"]; // Reemplaza esto con tu propio array
$miString = "Sharpy"; // Reemplaza esto con tu propio string
$miNumero = 22; // Reemplaza esto con tu propio número
