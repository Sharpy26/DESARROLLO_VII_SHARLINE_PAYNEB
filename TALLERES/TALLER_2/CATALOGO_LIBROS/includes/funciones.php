...
function obtenerLibros() {
    $libros = [
        [
            ...
            'descripcion' => 'Covey propone un enfoque basado en principios universales y atemporales para lograr una vida más efectiva, equilibada y con propósito.'
        ],
        [
        ...
        [
            ...
            'genero' => 'Novela',
            'descripcion' => 'La historia del caballero andante más famoso.'
        ],
        [
        ...
        [
            ...
            'descripcion' => 'Considerada una de las obras maestras de la ciencia ficción, Dune narra la historia de Paul Atreides, heredero de una noble familia destinada a gobernar el desértico planeta Arrakis, único lugar en el universo donde se encuentra la especia melange, la sustancia más valiosa que existe.'
        ]
    ];
