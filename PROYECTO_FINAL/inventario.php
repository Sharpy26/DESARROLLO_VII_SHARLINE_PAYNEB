...
$it = $conexion->query('SELECT * FROM inventario ORDER BY ingrediente');
$items = $it->fetchAll();
?>
<!DOCTYPE html>
<html>
...
<body>
	...
	<div class="nav-bar">
		...
		<button onclick="location.href='crear_inventario.php'">➕ Agregar Ingrediente</button>
	...
	<div class="table-container">
		<table cellpadding="6">
			...
			<tbody>
				...
				<tr>
					<td><?php echo $i['id'];?></td>
					<td><?php echo htmlspecialchars($i['ingrediente']);?></td>
					<td><?php echo $i['cantidad'];?></td>
					<td><?php echo htmlspecialchars($i['unidad']);?></td>
					<td class="actions"><a href="actualizar_inventario.php?id=<?php echo $i['id']; ?>">✏️ Actualizar</a></td>
				</tr>
				<?php } ?>
			</tbody>
		</table>
